...
import { InitialClaimResultSchema, ClaimResultSchema } from "./validation";
 ...
 */
export async function processClaimInitial(claim: ClaimRecord): Promise<ClaimResult> {
...
export async function processClaimCharges(
  ...
  console.log(`Processing Phase 2 (charges analysis) for claim ${claim.trackingNumber}...`);
 ...
 */
export async function processAllClaims(claims: ClaimRecord[]): Promise<ClaimResult[]> {
